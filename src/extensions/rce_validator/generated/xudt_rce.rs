...
#[derive(Clone)]
pub struct Proof(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for Proof {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl Proof {
    ...
    pub const FIELD_SIZES: [usize; 2] = [32, 1];
    pub const FIELD_COUNT: usize = 2;
    pub fn path(&self) -> Byte32 {
        Byte32::new_unchecked(self.0.slice(0..32))
    }
    pub fn height(&self) -> Byte {
        Byte::new_unchecked(self.0.slice(32..33))
    }
    pub fn as_reader<'r>(&'r self) -> ProofReader<'r> {
        ProofReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for Proof {
    type Builder = ProofBuilder;
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ProofReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ProofReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().path(self.path()).height(self.height())
    }
}
#[derive(Clone, Copy)]
pub struct ProofReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for ProofReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for ProofReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for ProofReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "path", self.path())?;
        write!(f, ", {}: {}", "height", self.height())?;
...
impl<'r> ProofReader<'r> {
    pub const TOTAL_SIZE: usize = 33;
    pub const FIELD_SIZES: [usize; 2] = [32, 1];
    pub const FIELD_COUNT: usize = 2;
    pub fn path(&self) -> Byte32Reader<'r> {
        Byte32Reader::new_unchecked(&self.as_slice()[0..32])
    }
...
impl<'r> molecule::prelude::Reader<'r> for ProofReader<'r> {
    type Entity = Proof;
    const NAME: &'static str = "ProofReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
...
impl ProofBuilder {
    ...
    pub const FIELD_SIZES: [usize; 2] = [32, 1];
    pub const FIELD_COUNT: usize = 2;
    pub fn path(mut self, v: Byte32) -> Self {
        self.path = v;
        self
    }
...
impl molecule::prelude::Builder for ProofBuilder {
    type Entity = Proof;
    const NAME: &'static str = "ProofBuilder";
    fn expected_length(&self) -> usize {
        Self::TOTAL_SIZE
    }
    fn write<W: ::molecule::io::Write>(&self, writer: &mut W) -> ::molecule::io::Result<()> {
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        Proof::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
pub struct ProofVec(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for ProofVec {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for ProofVec {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for ProofVec {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl ::core::default::Default for ProofVec {
    fn default() -> Self {
        let v: Vec<u8> = vec![0, 0, 0, 0];
        ProofVec::new_unchecked(v.into())
    }
}
impl ProofVec {
    pub const ITEM_SIZE: usize = 33;
    ...
    pub fn get(&self, idx: usize) -> Option<Proof> {
        if idx >= self.len() {
            None
        } else {
            Some(self.get_unchecked(idx))
    ...
    pub fn get_unchecked(&self, idx: usize) -> Proof {
        let start = molecule::NUMBER_SIZE + Self::ITEM_SIZE * idx;
        let end = start + Self::ITEM_SIZE;
        Proof::new_unchecked(self.0.slice(start..end))
    }
    pub fn as_reader<'r>(&'r self) -> ProofVecReader<'r> {
        ProofVecReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for ProofVec {
    type Builder = ProofVecBuilder;
    const NAME: &'static str = "ProofVec";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        ProofVec(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ProofVecReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        ProofVecReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
...
#[derive(Clone, Copy)]
pub struct ProofVecReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for ProofVecReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for ProofVecReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for ProofVecReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl<'r> ProofVecReader<'r> {
    ...
    pub fn get(&self, idx: usize) -> Option<ProofReader<'r>> {
        if idx >= self.len() {
            None
        } else {
            Some(self.get_unchecked(idx))
    ...
    pub fn get_unchecked(&self, idx: usize) -> ProofReader<'r> {
        let start = molecule::NUMBER_SIZE + Self::ITEM_SIZE * idx;
        let end = start + Self::ITEM_SIZE;
        ProofReader::new_unchecked(&self.as_slice()[start..end])
    }
}
impl<'r> molecule::prelude::Reader<'r> for ProofVecReader<'r> {
    type Entity = ProofVec;
    const NAME: &'static str = "ProofVecReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        ProofVecReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
#[derive(Debug, Default)]
pub struct ProofVecBuilder(pub(crate) Vec<Proof>);
impl ProofVecBuilder {
    pub const ITEM_SIZE: usize = 33;
    pub fn set(mut self, v: Vec<Proof>) -> Self {
        self.0 = v;
        self
    }
    pub fn push(mut self, v: Proof) -> Self {
        self.0.push(v);
        self
    }
    pub fn extend<T: ::core::iter::IntoIterator<Item = Proof>>(mut self, iter: T) -> Self {
        for elem in iter {
            self.0.push(elem);
        }
        self
...
impl molecule::prelude::Builder for ProofVecBuilder {
    type Entity = ProofVec;
    const NAME: &'static str = "ProofVecBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE + Self::ITEM_SIZE * self.0.len()
    }
    fn write<W: ::molecule::io::Write>(&self, writer: &mut W) -> ::molecule::io::Result<()> {
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        ProofVec::new_unchecked(inner.into())
    }
}
pub struct ProofVecIterator(ProofVec, usize, usize);
impl ::core::iter::Iterator for ProofVecIterator {
    type Item = Proof;
    fn next(&mut self) -> Option<Self::Item> {
        if self.1 >= self.2 {
            None
...
impl ::core::iter::ExactSizeIterator for ProofVecIterator {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
impl ::core::iter::IntoIterator for ProofVec {
    type Item = Proof;
    type IntoIter = ProofVecIterator;
    fn into_iter(self) -> Self::IntoIter {
        let len = self.len();
        ProofVecIterator(self, 0, len)
    }
}
impl<'r> ProofVecReader<'r> {
    pub fn iter<'t>(&'t self) -> ProofVecReaderIterator<'t, 'r> {
        ProofVecReaderIterator(&self, 0, self.len())
    }
}
pub struct ProofVecReaderIterator<'t, 'r>(&'t ProofVecReader<'r>, usize, usize);
impl<'t: 'r, 'r> ::core::iter::Iterator for ProofVecReaderIterator<'t, 'r> {
    type Item = ProofReader<'t>;
    fn next(&mut self) -> Option<Self::Item> {
        if self.1 >= self.2 {
            None
        } else {
...
impl<'t: 'r, 'r> ::core::iter::ExactSizeIterator for ProofVecReaderIterator<'t, 'r> {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
...
impl MerkleProof {
    ...
    pub fn leaves_path(&self) -> BytesVec {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
        BytesVec::new_unchecked(self.0.slice(start..end))
    }
    pub fn proof(&self) -> ProofVec {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[8..]) as usize;
        if self.has_extra_fields() {
            let end = molecule::unpack_number(&slice[12..]) as usize;
            ProofVec::new_unchecked(self.0.slice(start..end))
        } else {
            ProofVec::new_unchecked(self.0.slice(start..))
        }
    }
...
impl<'r> MerkleProofReader<'r> {
    ...
    pub fn leaves_path(&self) -> BytesVecReader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
        BytesVecReader::new_unchecked(&self.as_slice()[start..end])
    }
    pub fn proof(&self) -> ProofVecReader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[8..]) as usize;
        if self.has_extra_fields() {
            let end = molecule::unpack_number(&slice[12..]) as usize;
            ProofVecReader::new_unchecked(&self.as_slice()[start..end])
        } else {
            ProofVecReader::new_unchecked(&self.as_slice()[start..])
        }
    }
}
impl<'r> molecule::prelude::Reader<'r> for MerkleProofReader<'r> {
    ...
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        ProofVecReader::verify(&slice[offsets[1]..offsets[2]], compatible)?;
        Ok(())
    }
}
#[derive(Debug, Default)]
pub struct MerkleProofBuilder {
    pub(crate) leaves_path: BytesVec,
    pub(crate) proof: ProofVec,
}
impl MerkleProofBuilder {
    pub const FIELD_COUNT: usize = 2;
    pub fn leaves_path(mut self, v: BytesVec) -> Self {
        self.leaves_path = v;
        self
    }
    pub fn proof(mut self, v: ProofVec) -> Self {
        self.proof = v;
        self
    }
}
